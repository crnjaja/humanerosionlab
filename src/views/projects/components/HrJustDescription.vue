<template>
  <div class="hrjust-content">
    ...
    <div class="hrjust-compact">
      ...
      <!-- WHO (compact + grid logos + names) -->
      <section class="hrjust-who" id="consortium" aria-label="Consortium">
        <div class="who-head">
          <div class="who-icon"><i class="fas fa-university"></i></div>
          <div class="who-title-wrap">
            <h4 class="who-title">WHO</h4>
          </div>
        </div>

        <div class="logos-grid logos-grid--compact">
          <div class="logo-item">
            <img src="/images/logos/unibe.png" alt="Universität Bern" loading="lazy" />
            <p class="logo-name">Universität Bern</p>
          </div>

          <div class="logo-item">
            <img
              src="/images/logos/prague.png"
              alt="Institute of International Relations Prague"
              loading="lazy"
            />
            <p class="logo-name">Institute of International Relations Prague</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/trento.png" alt="Università di Trento" loading="lazy" />
            <p class="logo-name">Università di Trento</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/sinica.webp" alt="Academia Sinica" loading="lazy" />
            <p class="logo-name">Academia Sinica</p>
          </div>

          <div class="logo-item">
            <img
              src="/images/logos/cheng-kung.png"
              alt="National Cheng Kung University"
              loading="lazy"
            />
            <p class="logo-name">National Cheng Kung University</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/taiwan.png" alt="National Taiwan University" loading="lazy" />
            <p class="logo-name">National Taiwan University</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/gothenburg.png" alt="University of Gothenburg" loading="lazy" />
            <p class="logo-name">University of Gothenburg</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/amsterdam.png" alt="University of Amsterdam" loading="lazy" />
            <p class="logo-name">University of Amsterdam</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/haifa.webp" alt="University of Haifa" loading="lazy" />
            <p class="logo-name">University of Haifa</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/helsinki.webp" alt="University of Helsinki" loading="lazy" />
            <p class="logo-name">University of Helsinki</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/roma.png" alt="Sapienza Università di Roma" loading="lazy" />
            <p class="logo-name">Sapienza Università di Roma</p>
          </div>

          <div class="logo-item">
            <img src="/images/logos/stockholm.png" alt="Stockholm University" loading="lazy" />
            <p class="logo-name">Stockholm University</p>
          </div>
        </div>
      </section>
